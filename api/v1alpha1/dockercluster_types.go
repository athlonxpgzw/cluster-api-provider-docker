...
const (
	// ClusterFinalizer allows clean up resources associated with
	// DockerCluster before removing it from the apiserver.
	ClusterFinalizer = "dockercluster.infrastructure.x-k8s.io"
)
...
type DockerClusterSpec struct {
	...
	// LoadBalancerImage allows user to override the load balancer image. If not
	// specified a default image will be used.
	// +optional
